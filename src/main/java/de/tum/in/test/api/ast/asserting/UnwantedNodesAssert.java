...
public class UnwantedNodesAssert extends AbstractAssert<UnwantedNodesAssert, Path> {
    ...
    /**
     * (Designated constructor) Non-statically creates an unwanted node assertion object
     *
     * @param actual          The path from which on the Java-Files are checked
     * @param assertDirectory A flag, determining whether the path points to a file or to a directory
    ...
    /**
     * (Convenience constructor) Non-statically creates an unwanted node assertion object (language level is automatically set to Java 11)
     *
     * @param actual          The path from which on the Java-Files are checked
     * @param assertDirectory A flag, determining whether the path points to a file or to a directory
     */
    ...
    /**
     * (Convenience constructor) Non-statically creates an unwanted node assertion object (language level is automatically set to Java 11 and the file/directory flag is automatically set to file)
     *
     * @param actual The path from which on the Java-Files are checked
     */
    ...
    /**
     * Statically creates an unwanted node assertion object (language level is automatically set to Java 11 and the file/directory flag is automatically set to file)
     *
     * @param actual The path from which on the Java-Files are checked
    ...
    /**
     * Checks if the Java-files at and/or below the given path do not contain any unwanted statement
     *
