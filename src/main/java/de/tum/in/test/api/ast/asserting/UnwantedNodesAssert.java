...
public class UnwantedNodesAssert extends AbstractAssert<UnwantedNodesAssert, Path> {
    ...
    /**
     * Private constructor: Non-statically creates an unwanted node assertion
     * object
     *
     * @param actual          The path from which on the Java-Files are checked
     * @param assertDirectory true when the path points to a directory, false if it points to a file
