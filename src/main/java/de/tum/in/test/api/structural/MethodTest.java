		...
		for (int i = 0; i < expectedMethods.length(); i++) {
			...
			for (Method observedMethod : observedClass.getDeclaredMethods()) {
				...
				if (expectedName.equals(observedMethod.getName())) {
					...
					modifiersAreCorrect = checkModifiers(Modifier.toString(observedMethod.getModifiers()).split(" "),
							expectedModifiers);
			...
			checkMethodCorrectness(expectedClassName, expectedName, expectedParameters, nameIsCorrect,
					parametersAreCorrect, modifiersAreCorrect, returnTypeIsCorrect, annotationsAreCorrect);
		}
	}

	private static void checkMethodCorrectness(String expectedClassName, String expectedName,
			JSONArray expectedParameters, boolean nameIsCorrect, boolean parametersAreCorrect,
