...
public final class ThrowableSets {
	...
	static final Set<Class<? extends Throwable>> SAFE_TYPES = Set.of(AbstractMethodError.class,
			...
			IllegalCallerException.class, IllegalMonitorStateException.class, IllegalChannelGroupException.class,
			IllegalCharsetNameException.class, IllegalFormatCodePointException.class,
			IllegalFormatConversionException.class, IllegalFormatException.class, IllegalFormatFlagsException.class,
