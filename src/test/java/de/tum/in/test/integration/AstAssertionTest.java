...
public class AstAssertionTest {
    ...
    @Nested
    @DisplayName("If-Conditional-Test-Tests")
    class IfConditionalTestTests {
    ...
    @Nested
    @DisplayName("Switch-Conditional-Test-Tests")
    class SwitchConditionalTestTests {
    ...
    class CatchExceptionHandlingTestTests {
        ...
        @TestTest
        void test_testHasAtNoCatchExceptionHandling_Success() {
            String testHasAtNoCatchExceptionHandling_Success = "testHasAtNoCatchExceptionHandling_Success";
            tests.assertThatEvents().haveExactly(1, finishedSuccessfully(testHasAtNoCatchExceptionHandling_Success));
        }

        @TestTest
        void test_testHasAtNoCatchExceptionHandling_Fail() {
            String testHasAtNoCatchExceptionHandling_Fail = "testHasAtNoCatchExceptionHandling_Fail";
            tests.assertThatEvents().haveExactly(1, testFailedWith(testHasAtNoCatchExceptionHandling_Fail,
                    AssertionError.class,
                    "Unwanted statement found:\n"
                            + " - In src/test/java/de/tum/in/test/integration/testuser/subject/structural/astTestFiles/exceptionHandlings/yes/ClassWithAnyKindsOfExceptionHandlings.java:\n"
                            + "  - Catch-Statement was found:\n"
